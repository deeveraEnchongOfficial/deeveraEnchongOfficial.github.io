  ...
  <div class="custom-file">
   ...
   <div class="form-group col-md-6 mt-auto">
    ...
    <div class="form-group col-md-12">
      ...
      <input type="text" name="projectlink" class="form-control" id="email" placeholder="https://enchongdeeveraofficial.github.io/">
    </div>
...
while($data2=mysqli_fetch_array($queryrun2)){
  ...
  <div class="custom-file">
   ...
   <div class="form-group col-md-6 mt-auto">
    ...
    <div class="form-group col-md-12">
      <label for="email">Project Link</label>
      <input type="text" name="projectlink" value="<?=$data2['projectlink']?>" class="form-control" id="email" placeholder="https://enchongdeeveraofficial.github.io/">
    </div>
